...
route::get('/redirect', [HomeController::class, 'redirect']);
    ...
    route::get('/contact/customer',[HomeController::class,'contact']);
    ...
    route::get('category/barn', [AdminController::class, 'barn']);
...
//     route::get('/redirect', [HomeController::class, 'redirect'])->name('home-page');
